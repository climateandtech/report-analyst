...
from sqlalchemy import LargeBinary, MetaData, Table, Column, Text, DateTime, String
...
def get_file_storage(database_url: Optional[str] = None) -> Optional[PostgreSQLFileStorage]:
    """
