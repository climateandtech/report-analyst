...
class FlexibleDatasetRow(BaseModel):
    ...
    def get_score(self) -> Optional[float]:
        ...
        score = (
            self.get("score") or self.get("relevance_score") or self.get("confidence_score") or self.get("similarity_score")
        )
...
class BenchmarkDataset(BaseModel):
    ...
    def get_unique_reports(self) -> List[str]:
        ...
        report_ids = [r.get("report_id") or r.get("document_id") or r.get("doc_id") for r in self.results]
