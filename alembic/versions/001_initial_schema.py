...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint(
            'file_path', 'question_id', 'chunk_size', 'chunk_overlap',
            'top_k', 'model', 'question_set'
        )
    )
    ...
    op.create_index('idx_chunk_params', 'document_chunks', ['chunk_size', 'chunk_overlap'], unique=False)
