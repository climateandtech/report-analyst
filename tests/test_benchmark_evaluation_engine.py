...
from report_analyst.benchmark import BenchmarkDatasetContent, BenchmarkQuestion, GroundTruthChunk, RetrievalConfig, EvaluationMetrics
...
class TestEvaluationEngine:
    ...
    def sample_dataset(self):
        ...
        chunks_q1 = [
            GroundTruthChunk(chunk_id="chunk_1", relevance_score=1.0, is_evidence=True, evidence_order=1),
            GroundTruthChunk(chunk_id="chunk_2", relevance_score=0.8, is_evidence=True, evidence_order=2),
            GroundTruthChunk(chunk_id="chunk_3", relevance_score=0.0, is_evidence=False),
        ]
        
        chunks_q2 = [
            GroundTruthChunk(chunk_id="chunk_4", relevance_score=0.9, is_evidence=True, evidence_order=1),
            GroundTruthChunk(chunk_id="chunk_5", relevance_score=0.0, is_evidence=False),
        ]
        
        questions = [
            BenchmarkQuestion(question_id="q1", question_text="Question 1", ground_truth_chunks=chunks_q1),
            BenchmarkQuestion(question_id="q2", question_text="Question 2", ground_truth_chunks=chunks_q2),
        ]
    ...
    def test_evaluate_single_question(self, engine):
        ...
        expected_binary = [1, 0, 1]  # chunk_1: relevant, chunk_2: not relevant, chunk_3: relevant
