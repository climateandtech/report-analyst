...
from ...models.benchmark import BenchmarkDatasetContent, BenchmarkDataset, BenchmarkQuestion, GroundTruthChunk
...
class DatasetLoader:
    ...
    def _validate_and_parse(self, raw_data: Dict) -> BenchmarkDatasetContent:
        ...
        try:
            ...
            required_fields = ['dataset_id', 'name', 'description', 'version', 'question_set', 'questions']
